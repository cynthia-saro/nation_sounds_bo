 ...
 */
final class Version20191218164746 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE festival DROP date');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE festival ADD date DATE NOT NULL');
